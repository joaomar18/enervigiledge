...
def get_orno_we_516_db() -> EnergyMeterRecord:
    ...
    nodes.add(Node(NodeConfig(name="l1_apparent_power", type=NodeType.FLOAT, unit="kVA", calculated=True)))
    nodes.add(Node(NodeConfig(name="l1_power_factor", type=NodeType.FLOAT, unit="", calculated=True)))
    nodes.add(Node(NodeConfig(name="l1_power_factor_direction", type=NodeType.STRING, unit="", calculated=True)))
    ...
    nodes.add(Node(NodeConfig(name="total_power_factor", type=NodeType.FLOAT, unit="", calculated=True, logging=True, logging_period=1)))
    nodes.add(Node(NodeConfig(name="total_power_factor_direction", type=NodeType.STRING, unit="", calculated=True, logging=True, logging_period=1)))
    nodes.add(Node(NodeConfig(name="total_active_power", type=NodeType.FLOAT, unit="kW", calculated=True, logging=True, logging_period=1)))
    nodes.add(Node(NodeConfig(name="total_reactive_power", type=NodeType.FLOAT, unit="kVAr", calculated=True, logging=True, logging_period=1)))
    nodes.add(Node(NodeConfig(name="total_apparent_power", type=NodeType.FLOAT, unit="kVA", calculated=True, logging=True, logging_period=1)))
...
def get_sm1238_db() -> EnergyMeterRecord:
    ...
    nodes.add(Node(NodeConfig(name="total_power_factor_direction", type=NodeType.STRING, unit="", calculated=True)))
    nodes.add(Node(NodeConfig(name="total_active_power", type=NodeType.FLOAT, unit="kW", calculated=True, logging=True)))
    nodes.add(Node(NodeConfig(name="total_reactive_power", type=NodeType.FLOAT, unit="kVAr", calculated=True, logging=True)))
    nodes.add(Node(NodeConfig(name="total_apparent_power", type=NodeType.FLOAT, unit="kVA", calculated=True, logging=True)))
