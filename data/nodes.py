...
def get_orno_we_516_nodes() -> {ModbusRTUNode}:
    ...
    return {
        ...
        Node(name="l1_active_energy", type=NodeType.FLOAT, unit="kWh", incremental_node=True, calculate_increment=False, calculated=True, logging=True, logging_period=5),
        Node(name="l1_reactive_energy", type=NodeType.FLOAT, unit="kVArh", incremental_node=True, calculate_increment=False, calculated=True, logging=True, logging_period= 5),
...
def get_sm1238_nodes() -> {OPCUANode}:
    ...
    return {
        ...
        OPCUANode(name="l3_current", type=NodeType.FLOAT, node_id="ns=4;i=20", unit="A"),
