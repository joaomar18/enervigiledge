...
class Errors:
    ...
    class NODES:
        ...
        INVALID_PHASE = APIErrorDef(
            status_code=400,
            error_id="NODES.INVALID_PHASE",
            default_message="The eletrical phase provided is not valid.",
        )
        INVALID_PROTOCOL = APIErrorDef(
            status_code=400,
            error_id="NODES.INVALID_PROTOCOL",
            default_message="Provided protocol is not supported.",
        )
        ...
        INVALID_NODE_ATTRIBUTES_FIELDS = APIErrorDef(
            status_code=400,
            error_id="NODES.INVALID_NODE_ATTRIBUTES_FIELDS",
            default_message="Invalid field value in the node attributes."
        )
